        ...
        <div className="mx-auto max-w-container px-4 md:px-8">
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-[280px_1fr] md:items-start">
            <div className="glass overflow-hidden rounded-2xl p-2">
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-midnight">
                <Image
            ...
            <div className="space-y-6 text-glass leading-relaxed">
              <p>
          ...
          <section id="resume" className="mt-20 scroll-mt-28 border-t border-white/10 pt-16">
            <h2 className="font-display text-2xl font-semibold text-soft">
              Résumé &amp; CV
            </h2>
            <p className="mt-3 max-w-2xl text-glass">
              A downloadable PDF will live here. Until it is published, reach
              out via the contact page and I will share an up-to-date CV.
            </p>
            <Link
              href="/contact"
              className="mt-6 inline-flex rounded-full bg-gradient-main px-6 py-3 text-sm font-medium text-white shadow-glow"
            >
              Request CV
            </Link>
          </section>
